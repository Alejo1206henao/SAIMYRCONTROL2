...
/**
 * The primary key class for the SAIMYR_GAC_PERS database table.
 *
 */
@Embeddable
public class SaimyrGacPerPK implements Serializable {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SaimyrGacPerPK)) {
            return false;
        }
        SaimyrGacPerPK castOther = (SaimyrGacPerPK)other;
        return
